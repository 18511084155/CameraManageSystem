package cn.com.cms.user.web.servlet;
 ...
 * 用户模块WEB层
 * @author qdmmy6
 * request和session两个生命周期不一样，request的生命周期只在数据提交，提交以后即释放，session则是浏览器关闭才释放 
 */
...
public class UserServlet extends BaseServlet {
	...
	public String regist(HttpServletRequest request, HttpServletResponse response) 
		...
		return "f:/jsps/msg.jsp";//转发到msg.jsp，因为request中有东西，所以不能重定向
	}
